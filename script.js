...
const App = () => {
  ...
  // Knowledge base with BIA-specific additions
...
- **Training Programs**: Offers self-paced online courses (Esri E-Learning, Geospatial Training Services) and instructor-led events (BOGS-led, The GEO Project, Esri Training).
- **Focus**: GIS for land management, irrigation analysis, forest harvesting, wildland fire analysis, oil and gas management.
- **Website**: https://www.bia.gov/service/geospatial-training
- **Target Audience**: BIA employees and federally-recognized Tribes.
- **Request Process**: Contact geospatial@bia.gov for access.
